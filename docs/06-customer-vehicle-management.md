...
- ใช้ `Branch.IsCustomerDataPrivate` ตามพฤติกรรมเดิม
- สาขา private เห็นลูกค้าที่สาขาสร้าง/ผูก/เคยให้บริการ และรถที่สัมพันธ์กับลูกค้าเหล่านั้นหรือมีงานในสาขา
- สาขา non-private เห็นข้อมูลจากสาขาที่แชร์ รวมกับข้อมูลที่สัมพันธ์กับสาขาปัจจุบัน
